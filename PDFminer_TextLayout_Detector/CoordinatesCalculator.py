...
class CoordinatesCalculator:
    ...
    def IsObjectWithinCoordinateList(self, ObjectsCoordinates, CoordinateList):
        ...
        for Coords in CoordinateList:
            if self.IsObjectWithinCoordinateList(ObjectsCoordinates, Coords) >= 0:
                return True
