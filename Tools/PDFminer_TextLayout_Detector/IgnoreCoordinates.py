...
class IgnoreCoordinates:
    ...
    def AddCoordinates(self, PageNum, x0, y0, x1, y1):
        """Converts x0, y0, x1, y1 into class coordinates.coordinates and adds to ignore coordinates for PageNum"""
        self.AddCoordinates(PageNum, Coordinates.Coordinates(x0, y0, x1, y1))

    def AddCoordinates(self, PageNum, Coordinates):
        """Add Coordinates to specefic page ignore list"""
        #Coordinates should be a class Coordinates.Coordinates
